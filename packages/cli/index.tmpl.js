module.exports = ({ date, title, snippet }) => `import { BlogLayout, CenterSection, LeftSection, RightSection, Section } from '@components/layout';
import Editor from '@components/editor';
${snippet ? `import test from '${snippet}'` : ''}
